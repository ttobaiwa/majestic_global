        ...
        <div className="container position-relative">
          ...
          <div className="row">
            ...
            >
              ...
              <p className="lead">
                To be honest, this is just a stupid placeholder text. We dont
        ...
        <div className="container">
          ...
          <div className="row d-flex align-items-center">
            ...
            >
              ...
              <h3 className="py-5 border-top border-dark">
                We dont know exactly what we are doing. But thats good because
                we cant break something intentionally.
              </h3>
              <p>
            ...
            <div className="col-lg-6">
              <div className="row">
                ...
                <div className="col-lg-6" data-aos="fade-up">
                  <div className="display-1 fw-bold py-4">42%</div>
          ...
          <div className="col-md-7" data-aos="fade-left">
            <blockquote>
              <div className="fs-4 my-3 fw-light pt-4 border-bottom pb-3">
                “Iam the CEO of this company. So maybe you think "he will tell
                us something super awesome about it only". But no. Its a really
                strange place to work with creepy people all around. They do
                some computer stuff I dont understand. But I wear expensive
                Glasses and a Patagonia Hoodie. So Iam fine with it.”
              </div>
              <img
            ...
            <div className="row d-flex justify-content-center text-center">
              <div className="col-lg-8 text-center" data-aos="fade">
                ...
                <h2 className="display-6 mb-5">
                  ...
                  think you done something wrong. But in reality we just dont
          ...
          <div className="row d-flex justify-content-center">
            ...
            <div className="col-12 mt-4">
              <div className="row row-cols-1 row-cols-md-2 g-5 d-flex align-items-center">
                <div className="col-12 col-lg-6 col-xl-4" data-aos="fade-right">
                  <div className="card p-4 mt-3 border-0">
                    <div className="card-body">
                      ...
                      <blockquote className="blockquote">
                        <p>
                          "That service is really really good. And I dont say
                          that because they pay me a lot of money. I say that
                          because they dont pay me more money anymore if I dont
                          say it..."
                        </p>
                      </blockquote>
                ...
                <div className="col-12 col-lg-6 col-xl-4">
                  <div
                    className="card p-4 shadow mt-3 border-0"
                    data-aos="fade-down"
                  >
                    <div className="card-body">
                      <div className="text-dark py-2 fs-3">
                      ...
                      <blockquote className="blockquote">
                        <p>
                          "I really dont get what they do. Something with
                          Crypto, NFTs, SaaS and Cyber Security. Maybe an App
                      ...
                      <div className="d-flex justify-content-between border-top pt-3">
                        <p className="card-text">
                          <span className="h6 fw-5">Jenny Matrix</span>
                          <br />
                          <small className="text-muted">
                ...
                <div className="col-12 col-lg-6 col-xl-4">
                  <div className="card p-4 mt-3 border-0" data-aos="fade-left">
                    <div className="card-body">
                      <div className="text-dark py-2 fs-3">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <blockquote className="blockquote">
                        <p>
                          "I dont know if they are good at what they do. But
                      ...
                      <div className="d-flex justify-content-between border-top pt-3">
                        <p className="card-text">
                          <span className="h6 fw-5">Rustin Cohle</span>
                          <br />
                          <small className="text-muted">
                ...
                <div className="col-12 col-lg-6 col-xl-4">
                  <div className="card p-4 mt-3 border-0" data-aos="fade-right">
                    <div className="card-body">
                      <div className="text-dark py-2 fs-3">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <blockquote className="blockquote">
                        <p>
                          ...
                          I killed (accidentally) the CEOs cat with a
                          lawnmover."
                        </p>
                      </blockquote>
                      <div className="d-flex justify-content-between border-top pt-3">
                        <p className="card-text">
                          <span className="h6 fw-5">Richard Thornburg</span>
                          <br />
                          <small className="text-muted">
                ...
                <div className="col-12 col-lg-6 col-xl-4">
                  <div className="card p-4 mt-3 border-0" data-aos="fade-up">
                    <div className="card-body">
                      <div className="text-dark py-2 fs-3">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <blockquote className="blockquote">
                        <p>
                          "Iam just a guy who uploads his picture to
                          unsplash.com so that others can use me as placeholder
                          for stupid sample avatars. I dont even know that my
                          face is on this website."
                        </p>
                      </blockquote>
                      <div className="d-flex justify-content-between border-top pt-3">
                        <p className="card-text">
                          <span className="h6 fw-5">Harry Walters</span>
                          <br />
                          <small className="text-muted">
                            Gangster, In Bruges
                          </small>
                ...
                <div className="col-12 col-lg-6 col-xl-4">
                  ...
                  >
                    <div className="card-body">
                      ...
                      <div className="d-flex justify-content-between border-top pt-3">
                        <p className="card-text">
                          <span className="h6 fw-5">Lizzie Stark</span>
                          <br />
                          <small className="text-muted">
              ...
              <div className="d-flex">
                ...
                <div className="col-md-9 flex-fill">
                  ...
                  <p>
                    ...
                    ordered. But you cant order anything here, so we can give
        ...
        <div className="row d-flex justify-content-center">
          <div className="col-12 col-lg-8 text-center">
            <h3 className="fs-2 fw-light">
              ...
              <span className="fw-bold">monthly and free</span>
              newsletter!
            </h3>
          </div>
          <div className="col-12 col-lg-8 text-center">
              ...
              <div className="grouped-inputs border bg-light p-2">
                <div className="row">
                  ...
                  <div className="col-auto">
                    <a href="#" className="btn btn-dark py-3 px-5">
                      Subscribe
                    </a>
                  </div>
                </div>
